...
export const ENABLE_AI_CADDY = false; // Configuration to disable the AI caddy to prevent API errors
...
export const COLORS = {
  ...
  // Environment
  WALL: '#1B5E20',   
  GRASS_LIGHT: '#388E3C', // Traditional golf green
  GRASS_DARK: '#1B5E20',  // Darker green for walls
  WATER: '#175ABC',
  SAND: '#FEEFC3',        
