...
const ScorePill: React.FC<ScorePillProps> = ({ children, className }) => {
  return (
    <div
      className={`w-full select-none flex flex-row justify-center items-center rounded-full border border-white/10 bg-[#131313] px-[22px] py-3.5 text-base lg:text-lg font-medium text-white leading-none ${className}`}
    >
