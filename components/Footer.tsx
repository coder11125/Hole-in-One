...
const Footer: React.FC<FooterProps> = ({ gameState, par, numLevels, onRetry }) => {
  return (
    <ScorePill>
      ...
      <button className={'rounded-full bg-white/20 px-1 py-1 transition-colors hover:bg-white/30 active:bg-white/40'} onClick={() => onRetry()} aria-label='Retry Level' title='Retry Level'>
